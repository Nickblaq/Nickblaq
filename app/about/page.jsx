...
export default function index () {
    ...
    <main className="mx-auto w-full">
      ...
      <p>Fast forward to 2020, I switched to React because of it's community, educational rsources.
        Within a year I advanced to NEXTJS, which I has been a powerful and developer experience friendly.
         </p>

         <p>Fast forword 2023, I found decided to have a "hard reset" on my approach to building web technologies.
        With React 18, we are forced to rethink how modern web apps can be built.</p>

         <p>
            Most in my field describe themselves as Frontend Enginners but I think we more. <span>My future blog expands on this. Curious? Join waitlist!.</span>
